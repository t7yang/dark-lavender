...
const uiColor: UiColor = {
  ...
  'editor.selectionBackground': transparent(md.lightBlue[700], 0.5),
  'editor.inactiveSelectionBackground': transparent(md.lightBlue[700], 0.1),
  'editor.selectionHighlightBackground': transparent(md.lightBlue[700], 0.3),
  'editor.selectionHighlightBorder': colors.transparency,
  'editor.wordHighlightBackground': transparent(md.indigo[700], 0.5),
  'editor.wordHighlightBorder': colors.transparency,
  'editor.wordHighlightStrongBackground': transparent(md.pink[700], 0.5),
  'editor.wordHighlightStrongBorder': colors.transparency,
  'editor.findMatchBackground': transparent(md.orange[700], 0.5),
  'editor.findMatchHighlightBackground': transparent(md.orange[700], 0.2),
  'editor.findRangeHighlightBackground': transparent(md.orange[700], 0.2),
